...
exports.normalizeDinotube = normalizeDinotube;
 ...
 */
function normalizeDinotube(row) {
    ...
    return (0, normalizeAssoass_1.buildVideoDoc)({ source_url, thumbnail, title, channelName, publishedAt, duration, quality, likes, source: "dinotube.com" });
}
