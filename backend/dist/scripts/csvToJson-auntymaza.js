...
function mapCategory(raw) {
    ...
    if (r.includes("web series") || r.includes("webseries"))
        return "web-series";
    if (r.includes("short film"))
        return "short-film";
    if (r.includes("live show"))
        return "live-show";
    if (r.includes("desi mms"))
        return "desi-mms";
    if (r.includes("desi x"))
        return "desi-x";
    if (r.includes("desi amateur"))
        return "desi-amateur";
    if (r.includes("bangladeshi"))
        return "bangladeshi";
    if (r.includes("pakistani"))
        return "pakistani";
    if (r.includes("sri lankan"))
        return "sri-lankan";
    if (r.includes("big boobs"))
        return "big-boobs";
    if (r.includes("chamet"))
        return "chamet";
    if (r.includes("model"))
        return "model";
    if (r.includes("indian porn"))
        return "indian-porn";
    if (r.includes("xxx"))
        return "xxx";
    if (r.includes("solo"))
...
function extractPublishedAt(data) {
...
function parseTags(keywords1, keywords2, title) {
