...
export const metadata: Metadata = {
  title: "Terms of Service | Videx",
  description: "Terms of Service for Videx video platform",
  robots: {
    index: false,
    follow: false,
  },
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-6 text-neutral-300 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-white mt-8 mb-4">Content Removal Policy</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-white mt-8 mb-4">DMCA Compliance</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-white mt-8 mb-4">Content Disclaimer</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-white mt-8 mb-4">Severability</h2>
        <p>
